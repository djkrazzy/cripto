    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    {!! Form::open(['route' => 'user.usertransacciones.store', 'autocomplete'=> 'off', ]) !!}
                   ...
                   <hr>
                    ...
                    <input type="text" class="form-control" id="ewallet" name="ewallet" value="{{ $user->referencia->bitcoin}}"  >
                    </div>
...
<span aria-hidden="true">&times;</span>
       ...
       <div class="form-group">
        ...
        <input type="text" class="form-control" id="numero_cuenta" name="numero" value="{{ $user->referencia->numero_cuenta_banco}}"  >
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1"># Banco</label>
            <input type="text" class="form-control" id="bamco_retiro" name="banco" value="{{ $user->referencia->banco}}" >
            </div>
        </div>
