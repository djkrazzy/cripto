...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Transacciones',
            'route'         => 'admin.transacciones.index',
            'icon'        => 'far fa-fw fa-file',
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/select/1.3.4/js/dataTables.select.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/select/1.3.4/css/select.dataTables.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
